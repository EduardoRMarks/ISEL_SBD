...
public class PtUtil {
	...
	public static boolean addRecomendacao(Connection connection, String idPt, String nifCliente, String idEquipamento,
	...
	public static boolean addAtividade(Connection connection, String atividadeId, String idPt, String nomeAtividade,
			...
			String minParticipantes, String maxParticipantes, boolean confirmacao, String escalaoEtario,
			String nifClube) {
		PreparedStatement statement = null;
		try {
	...
	public static boolean confirmarOuCancelar(Connection connection, String action, String idAtividade) {
		...
		if (action.equals("confirmar")) {
			...
			String confirmarQuery = "UPDATE sbd_tp1_43498_45977_47739.atividade" + " SET Confirmacao = 1"
		...
		if (action.equals("cancelar")) {
			...
			String cancelarQuery = "UPDATE sbd_tp1_43498_45977_47739.atividade" + " SET Estado = 'Cancelado'"
					+ " WHERE Id = '" + idAtividade + "'";
