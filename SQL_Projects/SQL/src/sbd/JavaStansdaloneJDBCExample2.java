...
public class JavaStansdaloneJDBCExample2 {
	   ...
	   static final String DB_URL = "jdbc:mysql://localhost:3306/aula_pratica_1";
	   static final String USER = "root";
	   static final String PASS = "Ed49rd0v1ds!";
	   static int aluno = 21;
	   static String email = "a" + aluno + "@isel.pt";
	   static final String UPDATE = "UPDATE `aula_pratica_1`.`ALUNO`"
	   		+ "SET `email` = ?"
	   		+ "WHERE `numero` = ?;";
	   ...
	   static final String QUERY = "SELECT numero,"
		   		...
		   		+ "    nascido,"
		   		+ "    telemovel,"
		   		+ "    email FROM aula_pratica_1 WHERE numero = ?;";
