...
public class RoomOccupationUtil {
    ...
    // This method retrieves room occupation data for a given date range
	  public static List<OccupationData> getOccupationData(Date startDate, Date endDate) {
	        ...
	        try {
	            ...
	            String query = "SELECT sala.Id, clube.DesignacaoComercial, sala.Nome, atividade.IdPt, pt.Nome as PTNOME, atividade.Data, atividade.Estado, atividade.DiaDeSemana, atividade.HoraDeInicio, atividade.Duracao "
	                    ...
	                    + "LEFT JOIN clube ON sala.NifClube = clube.Nif "
	                    + "LEFT JOIN pt ON atividade.IdPt = pt.Id "
	            ...
	            while (resultSet.next()) {
	                ...
	                OccupationData occupationData = new OccupationData(roomId, clubName, roomName, state, ptNome, dayOfWeek, hour, idPt, duration);
	                ...
	                while (!calendar.getTime().after(endDate)) {
	                    ...
	                    boolean isOccupied = resultSet.getInt("ID") != 0 &&
	                            (resultSet.getDate("Data") != null && dateFormat.format(resultSet.getDate("Data")).equals(dateFormat.format(currentDate))) ||
	  ...
	  private static boolean checkWeeklyOccupation(Date currentDate, String dayOfWeek) {
		    String[] portugueseDaysOfWeek = {"Domingo", "Segunda-feira", "Terça-feira", "Quarta-feira", "Quinta-feira", "Sexta-feira", "Sábado"};
    ...
    public static class OccupationData {
        ...
        public OccupationData(int roomId, String clubName, String roomName, String state, String ptNome, String dayOfWeek, String hour, int idPt, int duration) {
            this.roomId = roomId;
